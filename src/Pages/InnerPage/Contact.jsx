  ...
  return (
    <div>
        ...
        <div className="Container bg-whiteSmoke dark:bg-normalBlack px-7 md:px-10 lg:px-14 2xl:px-20 py-10 md:py-14 lg:py-18 xl:py-20 2xl:py-[100px] ">
          <div className="flex items-center flex-col md:flex-row">
            ...
            >
              ...
              Have questions or need guidance? Reach out to us anytime—our expert astrologers are here to assist you with accurate insights and personalized advice.
              </p>
              ...
              <div className="flex items-center my-4 md:my-5 lg:my-[26px] group">
                ...
                <div className="ml-3 md:ml-4">
                  ...
                  <p className="font-Garamond text-lg sm:text-xl md:text-[22px] leading-[26px] text-lightBlack dark:text-white font-medium ">
                  Tilak Nagar, Dombivli East, Dombivli,<br/> Maharashtra 421201
                  </p>
                </div>
              </div>
            </div>
      ...
      <div data-aos="fade-down" data-aos-duration="1000">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3767.594538725196!2d73.08938207525378!3d19.212903882020054!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be795d0e826f317%3A0xafd6a05e5f3bc20f!2sUrjassvi%20Vastu%20-%20Mr.Mayuresh%20Dixit!5e0!3m2!1sen!2sin!4v1738114703125!5m2!1sen!2sin"
          height={450}
          allowFullScreen=""
          loading="lazy"
          className="w-full"
